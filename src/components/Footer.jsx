...
const Footer = () => {
	return (
		<footer
			id="footer"
			className="text-white bg-transparent bg-opacity-20 backdrop-filter backdrop-blur-md"
		>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div>
						...
						<p className="text-gray-400">
							This is some information about the Matrix App
						</p>
					</div>
					...
					<div>
						...
						<p className="text-gray-400 mb-4">E-mail: info@email.com</p>
						<p className="text-gray-400 mb-4">Phone: +99999999</p>
					</div>
				</div>
